        ...
        <div className='md:mx-28 mx-4 text-white py-10'>
            ...
            <div className='md:grid md:grid-cols-2 pt-12 items-center'>
                ...
                <div className=''>
                    ...
                    <p className='text-xl md:text-2xl py-4 tracking-wider'>DocLink is a web app where you can:
                    </p>
